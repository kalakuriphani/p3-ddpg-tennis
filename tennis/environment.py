...
def make_plot(scores_file,save_path,show=False):
    ...
    plt.plot([0, x_max], [0.5, 0.5], lw=1, c='grey', ls='--', label='Target Score = 0.5', zorder=1)
...
def make_plot_learning(scores_file,save_path,show=False):
    #scores/scores_train.npz
    with np.load(scores_file) as data:
        scores = data['arr_0']
    fig = plt.figure()
